...
public interface IPrefecturesRepositoryMapper extends BuildingRelatedRepositoryMapper<IPrefectures> {
	...
	@Select("select * from i_prefectures where prefectures_name like '%${iPrefectures.text}%' or prefectures_name like '%${iPrefectures.textZenkaku}%' or prefectures_name like '%${iPrefectures.textHankaku}%' limit ${limit}")
