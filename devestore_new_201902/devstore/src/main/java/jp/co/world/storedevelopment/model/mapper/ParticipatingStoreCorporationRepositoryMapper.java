...
public interface ParticipatingStoreCorporationRepositoryMapper extends RepositoryMapper<ParticipatingStoreCorporation> {
	...
	@Select("select * from participating_store_corporation where corporation_name like '%${participatingStoreCorporation.text}%' or corporation_name like '%${participatingStoreCorporation.textHankaku}%' or corporation_name like '%${participatingStoreCorporation.textZenkaku}%' or corporation_name like '%${participatingStoreCorporation.textZenkakuEisu}%' limit ${limit}")
