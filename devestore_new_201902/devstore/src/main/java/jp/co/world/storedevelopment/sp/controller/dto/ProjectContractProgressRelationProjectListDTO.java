...
public class ProjectContractProgressRelationProjectListDTO implements DTO<ProjectContractProgress> {
	...
	public ProjectContractProgressRelationProjectListDTO() {

	}

	public ProjectContractProgressRelationProjectListDTO(ProjectContractProgress model) {
