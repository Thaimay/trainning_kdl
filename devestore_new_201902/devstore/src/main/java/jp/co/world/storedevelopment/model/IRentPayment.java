...
import jp.co.world.storedevelopment.model.mapper.IRentPaymentModelMapper;
...
public class IRentPayment extends IActiveModel<IRentPayment> {
	...
	public String getRentPaymentName() {
		return rentPaymentName;
	}

	public void setRentPaymentName(String rentPaymentName) {
		this.rentPaymentName = rentPaymentName;
	}
	...
	@Override
	protected ModelMapper<IRentPayment> modelMapper(SqlSession session) {
		return session.getMapper(IRentPaymentModelMapper.class);
	}
