...
public class BuildingKeymanRelationBuildingCreateDTO implements DTO<BuildingKeyman> {
	...
	public BuildingKeymanRelationBuildingCreateDTO() {

	}

	public BuildingKeymanRelationBuildingCreateDTO(BuildingKeyman buildingKeyman) {
