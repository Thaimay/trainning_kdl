...
import jp.co.world.storedevelopment.model.mapper.IStepsRateCalculationDivisionModelMapper;

@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties({ "tableName" })
public class IStepsRateCalculationDivision extends IActiveModel<IStepsRateCalculationDivision> {
	...
	@Override
	protected ModelMapper<IStepsRateCalculationDivision> modelMapper(SqlSession session) {
		return session.getMapper(IStepsRateCalculationDivisionModelMapper.class);
	}
