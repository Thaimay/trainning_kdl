...
public class ProjectFindForm extends FindFormDTO {
	...
	public void defaultIsPrint() {
		setIsLandingNotPrint(true);
		setIsCurrentContractNotPrint(true);
		setIsProgressContractNotPrint(true);
		setIsPlanNotPrint(true);
		setIsCurrentSectionNotPrint(true);
		setIsProgressSectionNotPrint(true);
		setIsStatusNotPrint(true);
		setIsBasicNotPrint(true);
		setIsCorporationNotPrint(true);
	}
