...
public class ProjectSwitingItemControl extends ActiveModel<ProjectSwitingItemControl> {
	...
	private Boolean rentContractStartdateProgress = false;
	private Boolean rentContractEnddateProgress = false;
	private Boolean rentContractNumberOfYearProgress = false;
	...
	public Boolean getRentContractStartdateProgress() {
		return rentContractStartdateProgress;
	}

	public void setRentContractStartdateProgress(Boolean rentContractStartdateProgress) {
		this.rentContractStartdateProgress = rentContractStartdateProgress;
	}

	public Boolean getRentContractEnddateProgress() {
		return rentContractEnddateProgress;
	}

	public void setRentContractEnddateProgress(Boolean rentContractEnddateProgress) {
		this.rentContractEnddateProgress = rentContractEnddateProgress;
	}

	public Boolean getRentContractNumberOfYearProgress() {
		return rentContractNumberOfYearProgress;
	}

	public void setRentContractNumberOfYearProgress(Boolean rentContractNumberOfYearProgress) {
		this.rentContractNumberOfYearProgress = rentContractNumberOfYearProgress;
	}
