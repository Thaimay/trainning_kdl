let validation = {
	rules : {
		...
		project_edit_progress_negotiation_building_expected_value: {
			digits : true,
		},
		"projectContractProgressDto[1].contractNumberOfYear":{
			number: true,
            min: 0,
		},
        project_edit_implementation_schedule_datetime_year: {
            digits: true,
            min: 1970,
        },
        project_edit_implementation_schedule_datetime_month: {
            digits: true,
            range: [1,12],
        },
        project_edit_rent_contract_number_of_year_progress: {
        	number: true,
            min: 0,
        },
        project_edit_progress_contract_number_of_year: {
        	number: true,
            min: 0,
        },
        edit_project_section_progress_current_contracttsubo: {
        	number: true,
            min: 0,
        },
        edit_project_section_progress_negotiation_contracttsubo: {
        	number: true,
            min: 0,
        },
        profitExpectation: {
        ...
        "projectSectionProgressDto[1].contractTsubo": {
        	number: true,
            min: 0,
		},
		projectCategoryId: {
        ...
        project_edit_i_sales_agency_contract_number_of_year_progress: {
        	number: true,
            min: 0,
        },
        title: {
	...
	errorPlacement : function(error, element) {
		if (element.attr("name") !== undefined && (element.attr("name").substr(0, 13) === "openImageFile"
