...
angular
  ...
  .controller('NegotiationDetailController', function (BaseService, NegotiationDetailService, $scope, $timeout) {
    ...
    this.back = function () {
    	...
    	if(data_search.isImplemented && !data_search.isOpened && !data_search.isOwn && !data_search.isReadLater && data_search.fillText == ''){
    		data_search.search_next = false;
    	} else {
    	data_search.search_next = true;
    	}
