...
public interface ICorporationGroupRepositoryMapper extends RepositoryMapper<ICorporationGroup> {
	...
	@Select("select * from i_corporation_group where corporation_gp_name like '%${iCorporationGroup.text}%' or corporation_gp_name like '%${iCorporationGroup.textHankaku}%' limit ${limit}")
