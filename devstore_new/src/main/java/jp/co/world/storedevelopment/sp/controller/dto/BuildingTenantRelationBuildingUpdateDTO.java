...
public class BuildingTenantRelationBuildingUpdateDTO implements DTO<BuildingTenant> {
	...
	public BuildingTenantRelationBuildingUpdateDTO() {

	}

	public BuildingTenantRelationBuildingUpdateDTO(BuildingTenant buildingTenant) {
