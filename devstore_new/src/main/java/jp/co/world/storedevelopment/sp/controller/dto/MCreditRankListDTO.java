...
public class MCreditRankListDTO implements DTO<MCreditRank> {
	...
	public MCreditRankListDTO() {

	}

	public MCreditRankListDTO(MCreditRank mCreditRank) {
