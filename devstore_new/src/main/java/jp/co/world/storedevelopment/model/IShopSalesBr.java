...
import jp.co.world.storedevelopment.model.mapper.IShopSalesBrModelMapper;
...
public class IShopSalesBr extends IActiveModel<IShopSalesBr> {

	private String mainIncomeUnitCd;
	private String mainIncomeUnitName;
	...
	public String getMainIncomeUnitCd() {
		return mainIncomeUnitCd;
	}

	public void setMainIncomeUnitCd(String mainIncomeUnitCd) {
		this.mainIncomeUnitCd = mainIncomeUnitCd;
	}

	public String getMainIncomeUnitName() {
		return mainIncomeUnitName;
	}

	public void setMainIncomeUnitName(String mainIncomeUnitName) {
		this.mainIncomeUnitName = mainIncomeUnitName;
	}
	...
	@Override
	protected ModelMapper<IShopSalesBr> modelMapper(SqlSession session) {
		return session.getMapper(IShopSalesBrModelMapper.class);
	}
}