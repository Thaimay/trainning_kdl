...
import jp.co.world.storedevelopment.model.mapper.BuildingTradeAreaModelMapper;
...
public class BuildingTradeArea extends ActiveModel<BuildingTradeArea> {
	...
	@Override
	protected ModelMapper<BuildingTradeArea> modelMapper(SqlSession session) {
		return session.getMapper(BuildingTradeAreaModelMapper.class);
	}
