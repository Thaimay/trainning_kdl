...
public class BuildingPersonalDevelopRelationBuildingDetailDTO implements DTO<BuildingPersonalDevelop> {

	private Long id;
	private Long accountId;
	private String category;

	public BuildingPersonalDevelopRelationBuildingDetailDTO() {

	}

	public BuildingPersonalDevelopRelationBuildingDetailDTO(BuildingPersonalDevelop buildingPersonalDevelop) {
