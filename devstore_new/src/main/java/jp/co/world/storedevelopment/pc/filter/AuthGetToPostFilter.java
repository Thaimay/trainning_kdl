package jp.co.world.storedevelopment.pc.filter;
...
public class AuthGetToPostFilter implements Filter {

	private Logger logger = LoggerFactory.getLogger(AuthGetToPostFilter.class);
